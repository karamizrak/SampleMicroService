...
namespace SampleMicroService.EventBusRabbitMQ
{
    public class DefaultRabbitMQPersistentConnection: IRabbitMQPersistentConnection
    {
        ...
        public DefaultRabbitMQPersistentConnection( ILogger<IRabbitMQPersistentConnection> logger, int retryCount, IConnectionFactory connectionFactory)
        {
            _logger = logger;
        ...
        public bool IsConnect => _connection.IsOpen && !_disposed;
